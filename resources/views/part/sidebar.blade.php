<ul class="navbar-nav sidebar sidebar-danger  accordion" id="accordionSidebar">
    ...
    <li  class="nav-item">
        <a  class="nav-link" href="/home">
            <i style="color: #121212;" class="fa-solid fa-house"></i>
            <span style="color: #121212;">Home</span></a>
    </li>
    ...
    <li class="nav-item">
        <a style="color: #121212;" class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap"
            aria-expanded="true" aria-controls="collapseBootstrap">
            <i style="color: #121212;" class="fa-solid fa-book"></i>
            <span style="color: #121212;">Buku</span>
        </a>
    ...
    <li class="nav-item">
        <a style="color: #121212;" class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseForm"
            aria-expanded="true" aria-controls="collapseForm">
            <i style="color: #121212;" class="fa-solid fa-book-open"></i>
            <span style="color: #121212;">Kategori</span>
        </a>
    ...
    @if (Auth::user()->isAdmin == 1)
        <li class="nav-item">
            <a style="color: #121212;" class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTable"
                aria-expanded="true" aria-controls="collapseTable">
                <i style="color: #121212;" class="fa-solid fa-users"></i>
                <span style="color: #121212;">Anggota</span>
            </a>
    ...
    @if (Auth::user()->isAdmin == 1)
        <li class="nav-item">
            <a  style="color: #121212;" class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePeminjam"
                aria-expanded="true" aria-controls="collapsePeminjam">
                <i style="color: #121212;" class="fa-solid fa-user-pen"></i>
                <span style="color: #121212;">Peminjaman</span>
            </a>

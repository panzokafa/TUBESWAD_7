...
@section('content')
    <div class="card mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-dark">Form Edit Buku</h6>
        </div>
        <div class="card-body">
            <form action="/buku/{{ $buku->id }}" method="post"enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    <label for="Judul"class="text-dark font-weight-bold"> Judul Buku</label>
                ...
                <div class="form-group mb-3">
                    <label for="kode_buku"class="text-dark font-weight-bold"> Kode Buku</label>
                ...
                <div class="form-group mb-3">
                    <label for="kategori" class="text-dark font-weight-bold">Kategori</label>
                ...
                <div class="form-group mb-3">
                    <label for="pengarang" class="text-dark font-weight-bold">Pengarang</label>
                ...
                <div class="form-group mb-3">
                    <label for="penerbit" class="text-dark font-weight-bold">Penerbit</label>
                ...
                <div class="form-group mb-3">
                    <label for="tahun_terbit"class="text-dark font-weight-bold">Tahun Terbit</label>
                ...
                <div class="form-group mb-3">
                    <label for="deskripsi"class="text-dark font-weight-bold">Deskripsi</label>
                ...
                <div class="form-group">
                    <label for="photoProfile" class="text-md text-dark font-weight-bold">Tambah Sampul Buku</label>

...
@section('content')
    <form action="/profile/{{$profile->id}}" method="post" enctype="multipart/form-data">
        ...
        <div class="card pb-5">
            ...
            <div class="form-group mx-4 my-2">
                <label for="npm" class="text-md text-dark font-weight-bold">Nomor Induk Masiswa</label>
            ...
            <div class="form-group mx-4 my-2">
                <label for="photoProfile" class="text-md text-dark font-weight-bold">Tambah Photo Profile</label>
